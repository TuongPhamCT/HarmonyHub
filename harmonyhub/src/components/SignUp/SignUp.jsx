...
function SignUp() {
  return (
    <main
      ...
      className="flex overflow-hidden flex-col items-center pt-4 pb-32 mx-auto w-full max-w-[480px] max-h-[800px] bg-[image:var(--image-url)] bg-cover bg-center h-screen"
    >
